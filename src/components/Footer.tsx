...
import { ToolbarWithWrap, Logo, ResponsiveAccordion } from '../common/styledComponents';
import { VKIcon, ViberIcon, WhatsappIcon, TelegramIcon, VisaIcon, MirIcon, MaestroIcon, MastercardIcon } from '../common/icons';
